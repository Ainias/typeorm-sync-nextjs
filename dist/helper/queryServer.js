...
function queryServer(model, query, singleInstance = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield db.queryServer(undefined, Object.assign(Object.assign({}, query), { modelId: typeorm_sync_1.Database.getModelIdFor(model) }));
        if (result.success) {
            const modelContainer = typeorm_sync_1.SyncHelper.convertToEntityContainer(result.syncContainer);
